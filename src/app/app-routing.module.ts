...
const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'gpam',
        loadChildren: './core/gpam/gpam.module#GpamModule'
      },
      {
        path: 'asnaf',
        loadChildren: './core/asnaf/asnaf.module#AsnafModule'
      },
      {
        path: 'pembekal',
        loadChildren: './core/pembekal/pembekal.module#PembekalModule'
      },
      {
        path: 'pengurusan-kerjaya',
        loadChildren: './core/pengurusan-kerjaya/pengurusan-kerjaya.module#PengurusanKerjayaModule'
      },
      {
        path: 'pihak-ketiga',
        loadChildren: './core/pihak-ketiga/pihak-ketiga.module#PihakKetigaModule'
      },
      {
        path: 'superadmin',
        loadChildren: './core/superadmin/superadmin.module#SuperadminModule'
      },
      {
        path: 'urusetia',
        loadChildren: './core/urusetia/urusetia.module#UrusetiaModule'
      },
      {
        path: 'dpajpie',
        loadChildren: './core/dpajpie/dpajpie.module#DpajpieModule'
      },
      // Example
      {
        path: 'dashboards',
