...
@Component({
  selector: "app-kp-pihak-ketiga",
  templateUrl: "./kp-pihak-ketiga.component.html",
  styleUrls: ["./kp-pihak-ketiga.component.scss"],
  providers: [{ provide: TabsetConfig, useFactory: getTabsetConfig }],
})
export class KpPihakKetigaComponent implements OnInit {
  // Chart
  private chart2: any;
  private chart1: any;
