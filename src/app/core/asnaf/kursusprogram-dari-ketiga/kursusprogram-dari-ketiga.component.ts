...
@Component({
  selector: "app-kursusprogram-dari-ketiga",
  templateUrl: "./kursusprogram-dari-ketiga.component.html",
  styleUrls: ["./kursusprogram-dari-ketiga.component.scss"],
  providers: [{ provide: TabsetConfig, useFactory: getTabsetConfig }],
})
export class KursusprogramDariKetigaComponent implements OnInit {
  // Chart
  private chart2: any;
  private chart1: any;
