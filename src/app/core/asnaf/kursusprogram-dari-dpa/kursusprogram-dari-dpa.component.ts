...
@Component({
  selector: "app-kursusprogram-dari-dpa",
  templateUrl: "./kursusprogram-dari-dpa.component.html",
  styleUrls: ["./kursusprogram-dari-dpa.component.scss"],
  providers: [{ provide: TabsetConfig, useFactory: getTabsetConfig }],
})
export class KursusprogramDariDpaComponent implements OnInit {
  // Chart
  private chart2: any;
  private chart1: any;
  ...
  getChart() {
    ...
    // Create chart
    let chart = am4core.create("dpa1", am4charts.PieChart);
  ...
  getChart1() {
    ...
    let chart = am4core.create("dpa2", am4charts.PieChart3D);
    chart.hiddenState.properties.opacity = 0; // this creates initial fade-in
