...
export class TuntutanComponent implements OnInit {
  // Chart
  private chart1: any;
  ...
  getChartTuntutan1() {
    ...
    let chart = am4core.create("tuntutan1", am4charts.XYChart3D);
    ...
    series.name = "Tuntutan";
    series.clustered = false;
    series.columns.template.tooltipText =
      "Tuntutan {country} : [bold]{valueY}[/]";
    ...
    series2.columns.template.tooltipText = "Dana {country} : [bold]{valueY}[/]";
