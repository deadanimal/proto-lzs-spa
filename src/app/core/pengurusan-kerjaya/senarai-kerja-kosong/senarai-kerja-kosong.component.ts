...
@Component({
  selector: "app-senarai-kerja-kosong",
  templateUrl: "./senarai-kerja-kosong.component.html",
  styleUrls: ["./senarai-kerja-kosong.component.scss"],
})
export class SenaraiKerjaKosongComponent implements OnInit {
  // Chart
  private chart1: any;
  private chart2: any;
  private chart3: any;
